...
function Welcome({menuSelect}) {
  return (
    <div className='w-[250px] p-2 ml-[88px] z-10 h-[calc(100vh_-_81px)] mb-1 fixed bg-white overflow-y-scroll sidebar py-2 duration-500'  style={menuSelect == "Home" ? {marginLeft:"88px"}:{marginLeft:"-400px"}}>
