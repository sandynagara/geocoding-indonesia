...
function Welcome({menuSelect}) {
  return (
    <div className='w-[250px] p-2 ml-[88px] z-10 h-screen fixed bg-white overflow-scroll sidebar py-2 duration-500'  style={menuSelect == "Home" ? {marginLeft:"88px"}:{marginLeft:"-400px"}}>
